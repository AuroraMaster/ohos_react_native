...
```markdown
[Unreleased]: https://github.com/{用户名}/{仓库名}/compare/v1.2.0...HEAD
[1.2.0]: https://github.com/{用户名}/{仓库名}/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/{用户名}/{仓库名}/compare/v1.0.0...v1.1.0
...
变更类型分为 6 个官方强制标准类型和 2 个社区扩展可选类型，必须严格按优先级排序，不可随意调换顺序、自定义类型名称，确保全社区认知统一。

### 1. 标准强制类型（优先级从高到低）

| 类型（英文 / 中文） | 适用场景 | 编写要点 |
| :--- | :--- | :--- |
| Added / 新增 | 新增功能、特性、模块、API、配置项、文档、依赖等 | 明确功能的核心能力、适用场景，说明用户可获得的价值 |
...
仅当变更内容无法归入上述 6 类，且对用户有明确影响时使用，禁止滥用扩展类型覆盖标准类型：

- **Performance / 性能**：不改变功能逻辑的性能优化，如接口响应速度、内存占用、启动速度优化等
- **Documentation / 文档**：对用户使用有影响的文档变更，如新增使用教程、最佳实践、API 文档补全、重大勘误等
...
始终站在社区用户 / 赡献者视角编写，聚焦「变更对用户的影响」，而非内部技术实现细节。
...
[Unreleased]: https://github.com/demo/demo-project/compare/v1.2.0...HEAD
[1.2.0]: https://github.com/demo/demo-project/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/demo/demo-project/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/demo/demo-project/releases/tag/v1.0.0
```
