...
| 名称                          | 版本号                            | 是否发布npm仓 |
| ----------------------------- | -------------------------------|------------- |
| react-native-harmony.tgz        | 0.72.46 |   已发布     |
| react-native-harmony-cli.tgz    | 0.0.27 |   已发布     |
| react_native_openharmony-5.0.0.812.har                          | 0.72.46 |   已发布     |
| react_native_openharmony_release-5.0.0.812.har                  | 5.0.0.812 |   已发布     |
