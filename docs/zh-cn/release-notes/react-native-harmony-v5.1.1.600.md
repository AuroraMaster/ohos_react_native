...
| 名称                          | 版本号                            | 是否发布npm仓 |
| ----------------------------- | -------------------------------|------------- |
| react-native-harmony.tgz        | 0.72.75 |   已发布     |
| react-native-harmony-cli.tgz    | 0.0.30 |   已发布     |
| react_native_openharmony-5.1.1.600.har              | 0.72.75 |   已发布     |
| react_native_openharmony_release-5.1.1.600.har      | 5.1.1.600 |   已发布     |
