...
| 名称                          | 版本号                            | 是否发布npm仓 |
| ----------------------------- | -------------------------------|------------- |
| react-native-harmony.tgz        | 0.72.86 |   已发布     |
| react-native-harmony-cli.tgz    | 0.0.36 |   已发布     |
| react_native_openharmony-6.0.0.504.har              | 0.72.86 |   已发布     |
| react_native_openharmony_release-6.0.0.504.har      | 6.0.0.504 |   已发布     |
